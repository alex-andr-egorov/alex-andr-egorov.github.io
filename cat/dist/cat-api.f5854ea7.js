...
exports.eventSelect = void 0;
exports.fetchBreeds = fetchBreeds;
exports.fetchCatInfo = fetchCatInfo;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
_axios.default.defaults.headers.common["x-api-key"] = "live_mnSSEBghx2aGY7jFVu5xJ2blXd4XXDRrnw5lwFgI4XIvlaSKetieTFURkeuR0xQT";
var eventSelect = exports.eventSelect = document.querySelector(".breed-select");
var eventCatInfo = document.querySelector(".cat-info");
...
function fetchBreeds() {
  fetch("https://api.thecatapi.com/v1/breeds").then(function (responce) {
    var formJson = responce.json();
    return formJson;
  }).then(function (breadsArray) {
    breadsArray.forEach(function (element) {
      eventSelect.insertAdjacentHTML("beforeend", "<option value=\"".concat(element.id, "\">").concat(element.name, "</option>"));
    });
    return breadsArray;
...
function fetchCatInfo(idCat) {
  fetch("https://api.thecatapi.com/v1/breeds").then(function (responce) {
    ...
    return fetch("https://api.thecatapi.com/v1/images/search?breed_ids=".concat(idCat));
  }).then(function (response) {
    var formJson = response.json();
    return formJson;
  }).then(function (catInfoArray) {
    console.log(catInfoArray);
    eventCatInfo.innerHTML = "<h1>".concat(nameCat, "</h1><h2>").concat(temperament, "</h2><p>").concat(description, "</p><img src=\"").concat(catInfoArray[0].url, "\" alt=\"\" width=\"500\" height=\"400\">");
...
},{"axios":"../node_modules/axios/index.js"}],"cat-api.js":[function(require,module,exports) {
"use strict";

var _index = require("./index.js");
(0, _index.fetchBreeds)();
_index.eventSelect.addEventListener("change", function (event) {
  var selectedBreedId = event.target.value;
  if (selectedBreedId) {
    // Викликати функцію для виконання запиту за повною інформацією про кота
    (0, _index.fetchCatInfo)(selectedBreedId);
  }
});
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","cat-api.js"], null)
//# sourceMappingURL=/cat-api.f5854ea7.js.map